                ...
                <Col className='col-md-6 mx-auto'>
                  ...
                  >
                      ...
                      return (
                          ...
                          <div class="form-group py-4 country-box">
                              <select name="country" class="form-control" onClick={() => rotateicon()} >
                                <option value="" disabled selected>COUNTRY</option>
                                { countries.map((country) => {
                                  return <option value={country.name}>{country.name} ({country.code})</option>
                                  })
                                }
                              </select>
                          </div>
                          ...
                          <div class="form-group py-4">
                              <input  type="text" name="phone" Placeholder="PHONE NUMBER/LINE/WHATSAPP" class="form-control"  />
                          </div>
  
                          <div class="form-group py-4">
                              <textarea  type="text" name="message" rows={8} Placeholder="MESSAGE" class="form-control"  ></textarea>
                          </div>
                  

                          <div className="form-group py-4 text-center flex items-center justify-between">
                              <button
